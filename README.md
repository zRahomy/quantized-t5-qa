...
The evaluation focuses on five metrics:
...
The goal is to understand the practical trade-offs between accuracy, speed, and memory efficiency.
...
Preprocessing
The dataset is shuffled and subsampled to:
...
Quantization & Export
The trained model is saved as FP16 baseline, then quantized into INT8 and INT4 versions using BitsAndBytes.
...
FP16 is fastest due to GPU tensor-core optimization.
...
This project was developed for ARI5501 – Natural Language Processing as a final course project.